...
uni_gamma1 <- uni.slice(punto_inicial, function(gamma1){-( (beta_gamma_sim/gamma1)+((c_aux_ij/gamma1)^(d_aux_ij)) )-(d_aux_ij+alpha_gamma_sim+1)*log(gamma1)},
                       w=1, m=10, lower=0, upper=Inf)
